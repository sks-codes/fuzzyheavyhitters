...
fn garbler_preprocess_less_than_ss(
    ys: &[Mod2k],
    t: &Mod2k,
    ...
    C: AbstractChannel + Clone,
{
    ...
    let results = (0..inputs_y.len())
        ...
        .collect::<Vec<bool>>();
    let circuit_wires =
        gb_set_less_than_ss_inputs(&mut gb, &z1_values, &z2_values, &b_values, &results);
