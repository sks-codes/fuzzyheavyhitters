...
fn gen_layer_data<const N: usize>(key: [u8; AES_BLOCK_SIZE], modulus: u128, left: bool, right: bool) -> RdcfData<N> {
...
) -> RdcfCW<N>
{
    ...
    if !alpha_bit {
        ...
        cw.ys = (delta_ys.0 + left, delta_ys.1 + left);
...
impl<const N: usize> RdcfKey<N>
{
    ...
    // Need alpha < beta
    pub fn gen_RdcfKey(alpha_bits: &[bool], a: &RingVec<N>, b: &RingVec<N>, modulus: u128) -> (RdcfKey<N>, RdcfKey<N>) {
    ...
    pub fn eval_rdcf(&self, idx: &[bool], modulus: u128) -> RingVec<N> {
