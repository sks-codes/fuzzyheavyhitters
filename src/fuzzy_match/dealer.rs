...
impl FssDealer {
        ...
        loop {
            ...
            match signal_bytes {
                DealerSignal::RequestCheckKeys => {
                    ...
                    current_keys = self.generate_fss_keys_for_check(
    ...
    fn generate_fss_keys_for_check() -> Result<(Vec<IntervalFSSKey<1>>, Vec<IntervalFSSKey<1>>, Vec<(u128, u128)>), String> {
    ...
    fn generate_fss_keys_for_threshold() -> Result<(Vec<IntervalFSSKey<1>>, Vec<IntervalFSSKey<1>>, Vec<(u128, u128)>), String> {
